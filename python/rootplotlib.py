...
class CmsDecoration(object):
    ...
    def Draw(self):
        ...
        latex.SetTextAlign(self.align_)
        latex.DrawLatex(self._style.Get_cmsTextPosition().getX(),self._style.Get_cmsTextPosition().getY()-0.06, self.extraText)  #this can be improved to the actual cms text size+something
